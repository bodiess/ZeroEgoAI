...
module.exports = {
  content: [
    ...
    // Eğer ileride /lib veya /src açarsan hazır dursun:
    "./lib/**/*.{js,ts,jsx,tsx,mdx}",
  ],
  theme: {
    extend: {
      colors: {
        // global.css ile birebir isim eşleşmesi
        "zenith-turq": "rgb(var(--zenith-turq) / <alpha-value>)",
        "zenith-bg": "rgb(var(--zenith-bg) / <alpha-value>)",
        "zenith-bg-2": "rgb(var(--zenith-bg-2) / <alpha-value>)",
      ...
      boxShadow: {
        ...
        "ai-glow-strong":
          "0 0 15px rgba(92, 200, 255, 0.8), 0 0 30px rgba(92, 200, 255, 0.6)",
      },
      ...
      keyframes: {
        ...
        "ai-pulse": {
          "0%, 100%": { boxShadow: "0 0 5px var(--zenith-turq)" },
          "50%": {
            boxShadow:
              "0 0 15px var(--zenith-turq), 0 0 25px rgba(92, 200, 255, 0.4)",
          },
        },
      },
