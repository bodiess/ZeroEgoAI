  ...
  return (
    <div className={`min-h-screen ${PRIMARY_COLOR} flex items-center justify-center p-4`}>
      <div className="w-full max-w-lg bg-white rounded-xl shadow-2xl p-8 space-y-8">
        ...
        {/* Analiz Sonuç Alanı - REVSHARE ENTEGRASYONLU */}
        {analysisResult && (
          <section className="mt-8 p-6 bg-gray-50 rounded-lg shadow-inner border-l-4 border-zenith-primary">
            ...
            <div className="space-y-3">
                <p className="text-sm text-gray-700 border-b pb-2 border-gray-200">
                    ...
                    <span className={`ml-2 font-bold ${interpretCompoundScore(analysisResult.bileşik_skor).color} text-base`}>
                ...
                <div className="mt-4 p-4 bg-white rounded-lg border border-gray-100">
                    ...
                    <p className="text-sm text-gray-600 italic">
                        Kararınız, mantıksal verilerden çok anlık duygusal ağırlık içeriyor. Panik (Negatif) veya FOMO (Pozitif) anında işlem yapmak, uzun vadede servetinizi eritir.
                    </p>
                    
                    {/* 💰 REVSHARE ENTEGRASYON ALANI 💰 */}
                    <p className="mt-3 text-sm">
                        Önyargılarınızı kenara bırakın ve dünyanın en güvenli platformunda **yeni bir başlangıç** yapın. Bu linkten kayıt olarak, **Zenith Decision** topluluğuna katıldığınızı gösterin ve özel avantajlardan yararlanın:
                        <br/>
                        <a 
                            ...
                            style={{ backgroundColor: '#FCD535' }} // Binance'ın sarı rengi
                        >
                            🚀 Binance Hesabı Açın (Komisyon İndirimi Kazanma Şansı!)
                        </a>
                    </p>
                    {/* 💰 REVSHARE ENTEGRASYON SONU 💰 */}
                </div>
            </div>
          </section>
        )}
